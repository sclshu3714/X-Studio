...
namespace XStudio.SchoolSchedule
{
    ...
    public class ClassSchedule
    {
        ...
        /// 交换节次
        /// </summary>
        /// <param name="sreCode"></param>
        /// <param name="desCode"></param>
        public string ExchangeSessions(string souCode, string desCode)
        {
            Section? souSection = this[souCode];
            Section? desSection = this[desCode];
            if (souCode == null)
            {
                return "源节次为空，不能启用交换";
            }
