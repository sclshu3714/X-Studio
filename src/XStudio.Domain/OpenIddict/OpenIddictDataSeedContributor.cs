...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("XStudio") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "XStudio", DisplayName = "XStudio API", Resources = { "XStudio" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["XStudio_App:ClientId"];
        ...
        // Blazor Client
        var blazorClientId = configurationSection["XStudio_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["XStudio_Blazor:RootUrl"]?.TrimEnd('/');
