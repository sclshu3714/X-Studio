    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppX_RoomUsages", x => x.Code);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FloorCode = table.Column<string>(type: "varchar(128)", nullable: false, comment: "楼层编码")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UsageCode = table.Column<string>(type: "varchar(128)", nullable: false, comment: "用途编码")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Order = table.Column<long>(type: "bigint", nullable: false, comment: "序号"),
                    Name = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: false, comment: "名称")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppX_Classrooms_AppX_RoomUsages_UsageCode",
                        column: x => x.UsageCode,
                        principalTable: "AppX_RoomUsages",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
