...
namespace XStudio.Schools.Timetable {
    public class ScheduleDto : AuditedEntityDto<Guid> {
        ...
        /// </summary>
        [Description("编号")]
        [Column(TypeName = "string", Order = 2)]
        ...
        /// </summary>
        [Description("节次方案名称")]
        [Column(TypeName = "string", Order = 3)]
        ...
        /// </summary>
        [Description("学段")]
        [Column(TypeName = "string", Order = 4)]
        ...
        /// </summary>
        [Description("布局节次表")]
        [Column(TypeName = "string", Order = 8)]
        public List<DayOfWeek> LayoutOfWeek { get; set; } = new List<DayOfWeek>();
    }

    public class UpdateScheduleDto : AuditedEntityDto<Guid> {
        [Description("序号")]
        public int Order { get; set; } = 0;
        /// <summary>
        /// 节次表编号，主要用于快速识别和查询
    ...
    public class CreateScheduleDto : AuditedEntityDto<Guid> {
        [Description("序号")]
        [Column(TypeName = "int", Order = 1)]
        public int Order { get; set; } = 0;
        /// <summary>
